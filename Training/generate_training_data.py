...
class generate_training_data:
    ...
    def read_file_for_training_data(self):
    ...
    def get_next_batch(self):
        next_X_batch = self.training_data[0][self.batch]
        next_Y_batch = self.training_data[1][self.batch]
        self.batch_size += 1
        return next_X_batch, next_Y_batch

if __name__ == '__main__':
    trining_data = generate_training_data(sliding_window_size=20)
    print(trining_data.unique_words)
